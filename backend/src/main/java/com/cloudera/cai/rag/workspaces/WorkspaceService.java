...
public class WorkspaceService {
  ...
  public Types.Workspace create(Types.Workspace input) {
    var id = workspaceRepository.create(input);
  ...
  public static WorkspaceService createNull() {
    return new WorkspaceService(WorkspaceRepository.createNull());
  }
}
